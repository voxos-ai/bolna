...
import uvloop
from bolna.helpers.FirstMessage import FirstVoice
...
class TaskManager(BaseManager):
    def __init__(self, assistant_name, task_id, task, ws, fv:FirstVoice, input_parameters=None, context_data=None,
        ...
        self.fv.setOutputHandel(self.tools["output"])
        if task_id == 0:
